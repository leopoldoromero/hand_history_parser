...
class HandVsRangeEquityCalculator:
    ...
    def execute(self, hand1, opponent_range, board=[], num_simulations=500):
        """
        ...
        opponent_hands = self.range_generator.generate(
            expanded_range, excluded_cards=hand1 + board[:]
        )
        ...
        for opp_hand in opponent_hands:
            ...
            wins1, wins2, ties = self.simulate_matchup(
                hand1, opp_hand, board, num_simulations, deck_copy
            )
